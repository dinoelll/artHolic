      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
           ...
           <a href="feedWrite.go?project_id=${project_id}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i>피드등록</a>
           <a href="projectDel.do?project_id=${project_id}" class="btn btn-danger btn-sm">삭제</a>
...
$(document).ready(function() {
	  ...
	  function detailAjax() {
	    ...
	    $.ajax({
	      url: "projectDetail.ajax?project_id=" + project_id, // 서버에서 데이터를 가져올 URL
	      method: "GET",
	      async : false,
	      dataType: "json",
	      success: function(data) {
	        ...
	        $.each(data.feedList, function(index, detail) {
	          ...
	          html += '</span>';
	          html += '<span class="description">' + detail.date + '</span>';
	          html += '</div>';
	          html += '<p>' + detail.content + '</p>';
	          if (detail.feed_file_id != null) {
	        	html += '<div class="mailbox-feed_file-info">';
	        	html += '<a class="mailbox-feed_file-name"><i class="fas fa-paperclip"></i> &nbsp;' + detail.ori_photo_name + '</a>';
	        	html += '<a href="feed_fileDownload.do?id=' + detail.feed_file_id + '" class="btn btn-default btn-sm"><i class="fas fa-cloud-download-alt"></i></a>';
	        	html += '</div>';
